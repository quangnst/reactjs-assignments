...
const TodoApp = () => {
    ...
    return (
        <div className="todo-app">
            ...
            <div className="rounded mx-auto max-w-[600px] shadow-xl flex gap-4 my-4 relative">
                {
                    todos.length ? (
                        <button onClick={toggleAll} className="w-12 flex justify-center items-center absolute top-4"><img src="icon-arrow.svg" className="w-6" /></button>
                    ) : <></>
                }
                <input
                    type="text"
                    ...
                    className="text-base overflow-ellipsis w-full focus:outline-none py-4 sm:py-4.5 pr-8 pl-16 cursor-pointer"
                />
            </div>
                ...
                todos.length ? (
                    <>
                        ...
                        <div className="filters flex flex-col items-center justify-center gap-5 mt-6 md:flex-row">
                            <p className="text-gray-500 text-left flex items-center">{activeTodoCount} item{activeTodoCount > 1 ? 's' : ''} left!</p>
                            {
                            ...
                            <button
                                ...
                                className={clsx(
                                    "inline-block w-auto text-center min-w-[100px] px-4 py-2 rounded-md bg-red-500 text-white",
                                )}
                            >
                                Clear Completed
                            </button>
